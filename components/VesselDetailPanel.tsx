    ...
    >
      ...
      <div style={{ padding: '0 32px 24px', flex: 1 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 12 }}>
          <div>
            <p
              style={{ fontSize: 10, textTransform: 'uppercase', fontWeight: 700, color: '#44474e', margin: '0 0 2px' }}
            >
              Destination
            </p>
        ...
        <div style={{ height: 8, background: '#e6eeff', borderRadius: 99, overflow: 'hidden', marginBottom: 6 }}>
          <div
            style={{ height: '100%', width: `${vessel.voyageProgress}%`, background: '#000d22', borderRadius: 99 }}
          />
        </div>
        <div
          style={{ display: 'flex', justifyContent: 'space-between', fontSize: 10, fontWeight: 700, color: '#44474e' }}
        >
          ...
          {[
            ...
            >
              ...
              <span
                style={{
                  fontSize: 13,
                  fontFamily: label !== 'Last Update' ? 'monospace' : undefined,
                  fontWeight: 700,
                  color: '#000d22',
                }}
              >
